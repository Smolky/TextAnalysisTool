package es.um.dis.textstats.configuration;
...
import es.um.dis.textstats.DimensionsContainer;
import es.um.dis.textstats.dictionaries.Dictionary;
import es.um.dis.textstats.dimensions.CharacterCountDimension;
import es.um.dis.textstats.dimensions.CompositeDimension;
import es.um.dis.textstats.dimensions.DimensionInterface;
import es.um.dis.textstats.dimensions.MatchingWordsFromDictionary;
import es.um.dis.textstats.dimensions.PatternDimension;
import es.um.dis.textstats.dimensions.RegularVerbsCountDimension;
import es.um.dis.textstats.dimensions.WordsLongerThanNDimension;
...
public class ConfigurationLoader {
	...
	private DimensionInterface getDimensionFromKey (String key) throws ClassNotFoundException, NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, InstantiationException {
		...
		for (String internal_package : packages) {
			...
			// Inside a class
		    for (Class<DimensionInterface> test : getAllClasses ("es.um.dis.textstats.dimensions" + internal_package)) {
	...
	private DimensionInterface getDimensionFromClass (String class_name) throws ClassNotFoundException, NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, InstantiationException {
    	...
    	// Reflection load of the class
    	Class<?> c = Class.forName("es.um.dis.textstats.dimensions." + class_name);
